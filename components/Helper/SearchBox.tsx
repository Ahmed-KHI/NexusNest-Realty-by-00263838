...
const SearchBox = () => {
  return (
    <div
      className="w-full md:w-[80%] mx-auto bg-white h-[4rem] sm:h-[5rem] flex px-4 sm:px-8 flex-col
    ...
    >
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex items-center flex-[0.2] ml-8 space-x-6">
          ...
          <div
            className="w-12 h-12 bg-rose-600 flex items-center hover:bg-rose-800 transition-all duration-150
